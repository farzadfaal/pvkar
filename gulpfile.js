...
function pathsConfig(appName) {
  ...
  return {
    ...
    tomSelectSass: `${vendorsRoot}/tom-select/dist/scss`,
    vendorsJs: [
      `${vendorsRoot}/bootstrap/dist/js/bootstrap.bundle.js`,
      `${vendorsRoot}/tom-select/dist/js/tom-select.popular.js`,
    ],
    app: this.app,
...
function styles() {
  ...
  return src(`${paths.sass}/project.scss`)
    .pipe(
      sass({
        includePaths: [paths.bootstrapSass, paths.tomSelectSass, paths.sass],
